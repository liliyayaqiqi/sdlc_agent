"""Thin HTTP client over CXXtract2 endpoints used by review skills."""
...
class CxxtractHttpClient:
    """HTTP wrapper used by skill executors."""
    ...
    def explore_get_compile_command(self, *, file_key: str) -> dict[str, Any]:
        return self._post(
